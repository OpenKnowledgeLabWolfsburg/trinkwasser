...
class AppNavigationMenu extends Component {
    ...
    buildMenuContent = () => {
        ...
        let navListEntitiesSection = { type: "Link", elements: [
                        { component: Link, title: t('city.title'), to: '/city', id: 'city' },
            { component: Link, title: t('district.title'), to: '/district', id: 'district' },
            { component: Link, title: t('data.title'), to: '/data', id: 'data' }
        ]};
